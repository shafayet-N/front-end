...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Fixed Language Toggle - Bottom Left */}
      <Select value={language} onValueChange={setLanguage} disabled={isTransitioning}>
        <SelectTrigger
          className={`
            lg:hidden
      ...
      <nav key={language} className={`header-glass fixed top-0 z-50 shadow-soft w-full ${isRTL ? 'rtl' : 'ltr'}`}>
        ...
        {mobileOpen && (
          ...
          >
            ...
            <button
              onClick={() => setMobileLoginOpen(!mobileLoginOpen)}
              className="w-full flex items-center justify-between bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-4 rounded-xl font-semibold shadow-lg transition-all duration-300 hover:from-sky-600 hover:to-blue-700 hover:-translate
