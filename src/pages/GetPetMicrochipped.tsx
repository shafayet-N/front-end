...
export default GetPetMicrochipped;      setError('Microchip number must be 15 digits');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 pt-24 pb-12 px-4">
      ...
      {/* Floating support button */}
      <div className="fixed bottom-6 right-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full p-4 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110 cursor-pointer">
        <Phone className="w-6 h-6 text-white" />
      </div>
